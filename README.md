...
Repo name: `student-management-system-python`

Branches: `main`, `development`, `feature/auth`, `feature/student-crud`, `feature/file-handling`

Commits: `feat:`, `fix:`, `refactor:`, `docs:`, `style:`, `chore:`

## Checklist

- [x] CLI application
- [x] Auth system (hashing, sessions, admin-restricted admin creation)
- [x] Student CRUD
- [x] Role based access
- [x] JSON storage w/ auto recovery
- [x] Input validation
